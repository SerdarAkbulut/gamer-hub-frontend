...
const Header: React.FC = () => {
  ...
  const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
    if (event.key === "Enter") {
      ...
      router.push(`/games/search?q=${searchTerm}&page=1`);
    }
  };
      ...
      <header className="bg-gray-800 text-white px-4 py-4 flex items-center justify-between shadow-md xl:flex xl:gap-12 md:gap-12">
        ...
        <div className="flex w-full justify-center h-full">
          <Paper
            ...
            className=" w-1/2 sm:w-1/2 xl:w-1/2 mx-auto  "
          >
            <InputBase
              sx={{ ml: 1, flex: 1 }}
              placeholder="Ara"
